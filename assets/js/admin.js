...
function displayMessages() {
    ...
    if (allMessages.length === 0) {
        messagesList.innerHTML = '<p class="empty-state">No messages yet. Messages from clients will appear here.</p>';
        return;
    }
...
function filterMessages() {
    ...
    if (filtered.length === 0) {
        messagesList.innerHTML = '<p class="empty-state">No messages match your filters.</p>';
        return;
    }
